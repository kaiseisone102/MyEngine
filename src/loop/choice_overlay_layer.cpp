// =============================================================================
// choice_overlay_layer.cpp 窶・Horizontal / Vertical 繝ｬ繧､繧｢繧ｦ繝亥ｯｾ蠢懃沿
// =============================================================================
#define NOMINMAX
...
// 繝励Ο繧ｻ繧ｹ蜀・・繧､繝ｳ繧ｹ繧ｿ繝ｳ繧ｹ縺斐→縺ｫ荳諢上↑ ID 繧堤函謌・(ImGui Window 蜷阪・陦晉ｪ∝屓驕ｿ)
...
ChoiceOverlayLayer::ChoiceOverlayLayer(SceneRenderer& renderer, VulkanRenderer& vulkan, std::string prompt,
