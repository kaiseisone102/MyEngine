#pragma once
// =============================================================================
// loop/gameplay_layer.h — + nearbyChest_
// =============================================================================
...
class GameplayLayer : public ILayer {
   public:
    GameplayLayer(GameState& state, render::SceneRenderer& renderer, ILayerFactory& factory,
                  float gravity, float jumpSpeed, StageId initialStage);
