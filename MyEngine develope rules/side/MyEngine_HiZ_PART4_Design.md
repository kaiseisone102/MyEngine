...
これら残作業は **PART4 の完了を阻まない** (open-world 動作には支障なし)。 次のメジャー仕事候補は **PART4 完了畳み込み (§8) → 2C LOD / Phase 2F terrain bucket / 1I PART D bloom settings 連携 / 2A 多光源 (clustered forward+)**。
